...
echo "=========================================="
./scripts/data_preprocessing/01_download_data.sh "$SAMPLE_DIR"

echo ""
echo "Step 2: Preprocessing data..."
echo "=========================================="
./scripts/data_preprocessing/02_preprocessing.sh "$SAMPLE_DIR"

echo ""
echo "Step 3: Removing outliers..."
echo "=========================================="
./scripts/data_preprocessing/03_outlier_removal.sh "$SAMPLE_DIR"

echo ""
echo "Step 4: Generating background regions..."
echo "=========================================="
./scripts/data_preprocessing/04_background_generation.sh "$SAMPLE_DIR"

echo ""
echo "Step 5: Creating input data configuration..."
echo "=========================================="
./scripts/model_setup/05_create_input_data.sh "$SAMPLE_DIR"

echo ""
echo "Step 6: Calculating counts loss weight..."
echo "=========================================="
./scripts/model_setup/06_calculate_counts_loss_weight.sh "$SAMPLE_DIR"
