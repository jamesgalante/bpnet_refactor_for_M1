...
# Create bpnet_params.json file for BPNet architecture
echo "Creating bpnet_params.json file"

BASE_DIR=ENCSR000EGM

cat > $BASE_DIR/bpnet_params.json << 'EOF'
{
    "input_len": 2114,
...
echo "bpnet_params.json created successfully"